// מטרת פונקציית הביניים הזאת היא לבדוק
// האם המשתמש מחובר למערכת.
//
// הפונקציה מקבלת את הטוקן שנשלח מהלקוח,
// בודקת האם הטוקן תקין,
// ואם הכל תקין היא שומרת את פרטי המשתמש
// בתוך הבקשה.
//
// אם הטוקן חסר או לא תקין,
// השרת מחזיר שגיאת הרשאה.
